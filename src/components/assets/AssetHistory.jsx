...
export default function AssetHistory({ assetId, notes, onRefresh }) {
  ...
  const handleSave = async () => {
    ...
    setSaving(true);
    if (editing) await base44.entities.AssetNote.update(editing.id, form);
    else await base44.entities.AssetNote.create({ asset_id: assetId, ...form });
    setSaving(false);
    setShowModal(false);
    onRefresh();
  };
  ...
  const handleDelete = async (id) => {
    ...
    await base44.entities.AssetNote.delete(id);
    onRefresh();
  };
