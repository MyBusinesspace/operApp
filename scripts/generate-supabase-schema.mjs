...
// Emitted as ESM so both Vite (browser) and plain Node (API functions) can import it.
const typesFile = path.join(root, "packages", "base44-compat", "entity-field-types.js");
fs.writeFileSync(
  typesFile,
  `// Auto-generated by scripts/generate-supabase-schema.mjs — do not edit by hand\n` +
    `export default ${JSON.stringify(fieldTypes, null, 2)};\n`,
  "utf8"
);
